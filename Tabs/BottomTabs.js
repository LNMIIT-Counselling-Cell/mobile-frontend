...
export default function BottomTabs() {
  ...
  const getBottomTabDisplay = (route) => {
    const screenNames = ["Settings", "Meet our Developers", "Holiday Calendar", "Mess Menu", "Bus Time Table", "Standard Operating Procedures", "Important Contacts", "Head of Departments", "Head of Sections", "Hostel Contacts", "Cultural Council", "Science & Technology Council", "Sports Council", "COSHA Committee", "Badminton", "Basketball", "Chess", "Cricket", "Football", "Kabaddi", "Table Tennis", "Volleyball", "Menus", "Time Tables", "Today's Events", "Counselling Process", "Bazinga Menu", "The Food Barn Menu", "Generated Outpass", "Previous Outpass", "Open Source Libraries", "Curriculum (B. Tech. & M. Tech.)", "CSE Curriculum", "CCE Curriculum", "ECE Curriculum", "ME Curriculum", "Campus Area Map", "Academic Area Map", "Important Links", "TT Individual", "Club Fest", "ExtraPDF"];
