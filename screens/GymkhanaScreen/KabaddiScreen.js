...
export const KabaddiScreen = () => {

  const { colors } = useTheme()

  const imgData = require("../../assets/json/global.json").organization_img.sports.kabaddi;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/kabaddi.png')} style={styles.image} />
      </View>

      <PersonCard name={"Bharat Gupta"} position={"Coordinator"} phone="+919799348056" email={"20ucs050@lnmiit.ac.in"} />
      <PersonCard name={"Ishan Vadalia"} position={"Coordinator"} phone="+919099701922" email={"20ucs085@lnmiit.ac.in"} />
      <PersonCard name={"Vishal Agarwal"} position={"Coordinator"} phone="+918824578723" email={"20ucs231@lnmiit.ac.in"} />
