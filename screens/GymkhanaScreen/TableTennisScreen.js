...
export const TableTennisScreen = () => {

  const { colors } = useTheme()

  const imgData = require("../../assets/json/global.json").organization_img.sports.table_tennis;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/table_tennis.png')} style={styles.image} />
      </View>

      <PersonCard name={"Akshat Verma"} position={"Coordinator"} phone="+919621379705" email={"20ucs016@lnmiit.ac.in"} />
      <PersonCard name={"Krishna Baheti"} position={"Coordinator"} phone="+918949024501" email={"20uec071@lnmiit.ac.in"} />
      <PersonCard name={"Raghav Maheshwari"} position={"Coordinator"} phone="+919057574884" email={"20ucc085@lnmiit.ac.in"} />
