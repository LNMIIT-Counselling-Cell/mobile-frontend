...
export const BadmintonScreen = () => {

  const { colors } = useTheme()

  const imgData = require("../../assets/json/global.json").organization_img.sports.badminton;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/badminton.png')} style={styles.image} />
      </View>

      <PersonCard name={"Aman Bansal"} position={"Coordinator"} phone="+919929030584" email={"20ucs018@lnmiit.ac.in"} />
      <PersonCard name={"Rajat Bothra"} position={"Coordinator"} phone="+919998296647" email={"20ucs157@lnmiit.ac.in"} />
      <PersonCard name={"Vansh Patel"} position={"Coordinator"} phone="+919870056089" email={"20ucs217@lnmiit.ac.in"} />
