...
export const TennisScreen = () => {
  ...
  const imgData = require("../../assets/json/global.json").organization_img.sports.tennis;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/tennis.png')} style={styles.image} />
      </View>

      <PersonCard name={"Aayush Sheth"} position={"Coordinator"} phone="+917567794411" email={"20ucs004@lnmiit.ac.in"} />
      <PersonCard name={"Kush Desai"} position={"Coordinator"} phone="+917984275253" email={"20ucs104@lnmiit.ac.in"} />
