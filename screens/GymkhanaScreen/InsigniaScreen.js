...
export const InsigniaScreen = () => {

  const { colors } = useTheme()

  const imgData = [
    {
      imgsrc: require('../../assets/cult_clubs/insignia/1.jpg')
    },
    {
      imgsrc: require('../../assets/cult_clubs/insignia/2.jpg')
    },
    {
      imgsrc: require('../../assets/cult_clubs/insignia/3.jpg')
    },
    {
      imgsrc: require('../../assets/cult_clubs/insignia/4.jpg')
    },
    {
      imgsrc: require('../../assets/cult_clubs/insignia/5.jpg')
    }
  ]
