...
export const SquashScreen = () => {

  const { colors } = useTheme()

  const imgData = require("../../assets/json/global.json").organization_img.sports.squash;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/squash.png')} style={styles.image} />
      </View>

      <PersonCard name={"Hemang Singhal"} position={"Coordinator"} phone="+919412938525" email={"21ucs092@lnmiit.ac.in"} />
