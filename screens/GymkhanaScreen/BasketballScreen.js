...
export const BasketballScreen = () => {
  ...
  const imgData = require("../../assets/json/global.json").organization_img.sports.basketball;
  imgData.forEach(img => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.headercontainer}>
        <Image source={require('../../assets/sports/basketball.png')} style={styles.image} />
      </View>

      <PersonCard name={"Ankit Gulia"} position={"Coordinator"} phone="+919812711086" email={"20ucc015@lnmiit.ac.in"} />
      <PersonCard name={"Bharghav Patel"} position={"Coordinator"} phone="+918128981684" email={"20ucs051@lnmiit.ac.in"} />
